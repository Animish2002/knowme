  ...
  return (
    <Layout>
      <div className="flex justify-center items-center flex-1">
        <div className="loginbox w-[750px] h-[540px] border-2 border-sky-700 shadow-md shadow-sky-700 rounded-lg p-8 flex flex-col md:flex-row">
          ...
          <div className="flex-1">
            <form onSubmit={handleSubmit} className="space-y-4">
              <h1 className="text-4xl font-bold text-center mb-10 mt-2 text-gray-600">
                Sign Up
              </h1>
              ...
              <div className="relative">
                <button
                  ...
                  className="text-gray-800 bg-white border-2 border-gray-300 rounded-md focus:outline-none focus:border-blue-500 font-medium rounded-lg text-sm px-[83px] py-2.5 text-center inline-flex items-center"
                ...
                {isOpen && (
                  <div
                    ...
                    className="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-60 absolute top-full mt-1"
                  >
              ...
              <div className="flex">
                ...
                <Link
                  to="/login"
                  className="pl-2 text-blue-400 hover:text-blue-700 hover:underline"
                >
                  Login here
                </Link>
              </div>
